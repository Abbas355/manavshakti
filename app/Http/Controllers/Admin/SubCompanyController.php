...
class SubCompanyController extends Controller
{
    public function index(Request $request)
    {
        ...
        try {
            ...
            $companies = (new CompanyListService())->execute($request,'sub');
            
            

// // Filter companies where the user's subrole is 'subcompany'
// $filteredCompanies = $companies->filter(function ($company) {
//     return isset($company['user']['subrole']) && $company['user']['subrole'] === 'subcompany';
// });
// $companies=$filteredCompanies->values();
// // Return the filtered result
// //return $companies; // Use `values()` to reindex the collection
