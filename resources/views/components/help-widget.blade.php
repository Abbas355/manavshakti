<div>
    ...
    <!-- <div class="help-icon">
        ...
        <div class="help-menu-wrapper">
            <div class="help-menu">
                <ul class="capitilize">
                    <li> <a href="https://templatecookie.com/get-support">Create Support Ticket</a> </li>
                    <li> <a href="https://templatecookie.helpcenter.guide/collections/jobpilot-job-portal-83c890-051be">Documentation</a></li>
                    <li> <a href="https://roadmap.templatecookie.com/t/roadmap/jobpilot">Product Roadmap</a></li>
                </ul>
                <hr>
                <ul>
                    <li><a href="https://templatecookie.com/elite-support">Get Elite Support</a></li>
                    <li><a href="https://templatecookie.com/hire-us">Hire US</a></li>
                </ul>
                <hr>
                <ul>
                    <li><a href="https://templatecookie.com/">Developed by Templatecookie</a> </li>
                </ul>
            </div>
        </div>
    </div> -->
